...
export type CalendarProps = React.ComponentProps<typeof DayPicker> & { selectedPreset?: string };

function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  const { from, to } = JSON.parse(JSON.stringify(props.selected));
    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_today: `bg-slate-100 ${
          props.selectedPreset === "yesterday" ? "text-slate-900" : condition ? "text-slate-50" : "text-slate-900"
