import { UserAccount } from "@app/auth";
...
export function UserAvatar(props: Props) {
  ...
  return <img onError={handleError} className="h-8 w-8 lg:h-6 lg:w-6 rounded-full" src={props.user.avatarUrl} alt={props.user.name} />;
}
