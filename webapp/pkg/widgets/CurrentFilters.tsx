...
function FilterChip(props: ChipProps) {
  ...
  return (
    <span className="inline-flex items-center relative group border rounded py-1 px-2 text-sm min-w-[6rem] bg-gray-50">
      ...
      >
        <span className="flex space-x-2 items-center text-red-600">
